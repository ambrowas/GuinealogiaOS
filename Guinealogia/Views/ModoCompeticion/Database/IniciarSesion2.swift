...
//                                )
//                        }
//                        NavigationLink("REGISTRAR NUEVO USUARIO", destination: MenuModoCompeticion(userId:"DummyuserId", userData: UserData(), viewModel: RegistrarUsuarioViewModel())).hidden()
//                        
//                        Button(action: {
...
//                            RegistrarUsuario(userId: .constant("123456789"))
//                                .onDisappear {
//                                    presentationMode.wrappedValue.dismiss()
//                                }
//                        }
