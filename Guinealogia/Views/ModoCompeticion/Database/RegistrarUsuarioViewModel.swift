...
class RegistrarUsuarioViewModel: ObservableObject {
                        ...
                        if success {
                            ...
                            self.signIn(email: self.email, password: self.password) { result in
                                ...
                                case .success:
                                    ...
                                    // Display the success alert here
    ...
    func displayAlert(message: String, type: AlertType, dismissAction: (() -> Void)? = nil) {
        DispatchQueue.main.async {
            ...
            self.alertType = type
            self.showAlert = true
            self.dismissAction = dismissAction  // Assuming dismissAction is a stored property in your ViewModel
        }
    }


    func navigateToProfile() {
        print("Attempting to navigate to user profile...")
